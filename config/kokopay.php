...
return [
    ...
    */
    ...
    'merchant_id' => env('KOKOPAY_MERCHANT_ID', 'dummy_kokopay_merchant_id'),
    'api_key' => env('KOKOPAY_API_KEY', 'dummy_kokopay_api_key'),

    'private_key' => env('KOKOPAY_PRIVATE_KEY', '-----BEGIN RSA PRIVATE KEY-----
DUMMYKOKOPAYPRIVATEKEYPLACEHOLDERONLYNOTREAL=
-----END RSA PRIVATE KEY-----'),
    'public_key' => env('KOKOPAY_PUBLIC_KEY', '-----BEGIN PUBLIC KEY-----
DUMMYKOKOPAYPUBLICKEYPLACEHOLDERONLYNOTREAL=
-----END PUBLIC KEY-----'),
    
    'plugin_name' => env('KOKOPAY_PLUGIN_NAME', 'Chance_Laptops'),
