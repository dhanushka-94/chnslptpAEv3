<?php
/*
 * KOKO PAY SAMPLE / DUMMY CREDENTIALS
 * ===================================
 * Local/dev placeholders only — not real payment credentials.
 * Environment: SANDBOX
 */

session_start();

// Koko Pay Configuration - DUMMY / SANDBOX
$merchant_id = 'dummy_kokopay_merchant_id';
$api_key = 'dummy_kokopay_api_key';
$plugin_name = "customapi";
$plugin_version = "1.0.1";
$currency = 'LKR';

// Environment URLs - SANDBOX
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? 'https' : 'http';
$base_url = $protocol . "://" . $_SERVER['HTTP_HOST'] . rtrim(dirname($_SERVER['PHP_SELF']), '/');
$koko_api_url = 'https://qaapi.paykoko.com/api/merchants/orderCreate'; // sandbox

// RSA Private Key for signing - DUMMY
$private_key = '-----BEGIN RSA PRIVATE KEY-----
DUMMYKOKOPAYPRIVATEKEYPLACEHOLDERONLYNOTREAL=
-----END RSA PRIVATE KEY-----';

// Koko Pay Public Key - DUMMY
$koko_public_key = '-----BEGIN PUBLIC KEY-----
DUMMYKOKOPAYPUBLICKEYPLACEHOLDERONLYNOTREAL=
-----END PUBLIC KEY-----';
