...
@section('title', 'Invoice #' . $order->order_number . ' - CHANCE LAPTOPS')
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium capitalize 
                                    {{ $order->status === 'delivered' ? 'text-green-600' : 
                                       ($order->status === 'cancelled' ? 'text-red-600' : 'text-red-600') }}">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium capitalize
                                    {{ $order->payment_status === 'paid' ? 'text-green-600' : 
                                       ($order->payment_status === 'failed' ? 'text-red-600' : 'text-red-600') }}">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-gray-800 space-y-2">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900">CHANCE LAPTOPS</p>
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <p class="text-gray-800">info@chancelaptops.ae</p>
                                </div>
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <p class="text-gray-800">www.chancelaptops.ae</p>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="text-xs text-gray-700 space-y-2">
                                <p>• Thank you for choosing CHANCE LAPTOPS - Your Trusted IT Partner</p>
...
<div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center no-print">
    <button onclick="window.print()" 
            class="inline-flex items-center px-8 py-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-bold shadow-lg text-lg">
    ...
    <a href="{{ route('orders.track') }}" 
       class="inline-flex items-center px-6 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-100 transition-colors font-medium shadow-lg">
