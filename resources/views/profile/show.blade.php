                    ...
                    <form action="{{ route('profile.photo.update') }}" method="POST" enctype="multipart/form-data" class="w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" 
                                   name="profile_photo" 
                                   accept="image/*"
                                   class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-slate-900 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-red-500 file:text-black hover:file:bg-red-600 transition-colors"
                        ...
                        <div id="imagePreview" class="hidden mb-4">
                            <img id="previewImg" class="w-20 h-20 rounded-full object-cover mx-auto border-2 border-slate-200">
                        </div>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <form action="{{ route('profile.password.update') }}" method="POST">
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="submit" 
                                class="bg-red-600 hover:bg-red-700 text-gray-900 font-medium py-2 px-6 rounded-lg transition-colors">
                            Update Password
                        </button>
                    </div>
                </form>
