...
@section('keywords', 'computer repair, laptop repair, service center, Chance Laptops, United Arab Emirates, hardware repair, software installation, virus removal')
    ...
    <section class="info-section info-section--alt -mt-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="tel:971581811579" class="info-stat-card hover:!border-red-300">
                    <div class="info-card__icon mx-auto mb-3">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    </div>
                    <p class="info-stat-card__value text-lg">076 444 222 1</p>
                    <p class="info-stat-card__hint">+971 58 181 1579</p>
                </a>
                <a href="https://wa.me/971581811579" target="_blank" rel="noopener noreferrer" class="info-stat-card hover:!border-emerald-300">
