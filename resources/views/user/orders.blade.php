...
@section('title', 'My Orders - CHANCE LAPTOPS')
@section('description', 'View and track your CHANCE LAPTOPS orders, download invoices, and manage your purchase history.')
...
<div class="min-h-screen bg-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Filters -->
        <div class="bg-gradient-to-r from-white to-gray-50 rounded-xl border border-gray-200 p-6 mb-8">
            <form method="GET" action="{{ route('user.orders') }}" class="flex flex-wrap items-center gap-4">
                ...
                <div class="flex-1 min-w-64">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <select id="status" 
                            name="status"
                            class="px-4 py-2 bg-white border border-gray-300 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                ...
                <div class="flex items-end">
                    ...
                    @if(request()->hasAny(['search', 'status']))
                        <a href="{{ route('user.orders') }}" 
                           class="ml-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
                            Clear
                        </a>
                    @endif
                </div>
                        ...
                        <div class="px-6 py-4 border-b border-gray-200">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    <p class="text-lg font-medium text-gray-900">{{ $order->formatted_total }}</p>
                        ...
                        <div class="px-6 py-4">
                            <div class="flex items-center space-x-4 mb-4">
                                ...
                                @if($order->shipping_address)
                                    ...
                                    <span class="text-sm text-gray-600">{{ $order->shipping_city }}</span>
                                @endif
                            </div>
                            ...
                            <div class="space-y-2">
                                @foreach($order->orderItems->take(3) as $item)
                                    <div class="flex items-center space-x-3 text-sm">
                                        ...
                                        <span class="flex-1 text-gray-700">{{ $item->product_name }}</span>
                                        <span class="text-gray-900 font-medium">{{ $item->formatted_total_price }}</span>
                                    </div>
                                @endforeach
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex space-x-3">
                                    <a href="{{ route('user.orders.detail', $order->order_number) }}" 
                                       class="text-red-600 hover:text-[#d97706] text-sm font-medium transition-colors">
                                        View Details
                                    </a>
...
<div id="cancelContactModal" class="fixed inset-0 bg-gray-900/40 hidden z-50 flex items-center justify-center p-4">
    <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 max-w-md w-full">
        ...
        <div class="p-6">
            <div class="mb-4">
                <p class="text-gray-700 mb-4">To cancel your order <strong class="text-white" id="modalOrderNumber"></strong>, please contact our customer service team:</p>
            </div>
            
            <div class="mb-6 p-4 bg-red-500/10 border border-red-300/20 rounded-lg">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3 p-3 bg-gray-50/30 rounded-lg">
                    ...
                    <div>
                        ...
                        <a href="#" id="emailLink" class="text-red-400 hover:text-red-300 text-sm">info@chancelaptops.ae</a>
...
function showCancelContactInfo(orderNumber) {
    ...
    const emailUrl = `mailto:info@chancelaptops.ae?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
