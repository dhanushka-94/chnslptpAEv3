...
@section('title', 'Account Settings - CHANCE LAPTOPS')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('user.dashboard') }}" class="bg-gray-50 hover:bg-gray-200 text-gray-900 px-4 py-2 rounded-lg transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl border border-gray-200/30 p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Settings Categories</h3>
                    <nav class="space-y-2">
                        <a href="#notifications" class="flex items-center p-3 text-gray-700 hover:text-primary-400 hover:bg-gray-100/50 rounded-lg transition-colors">
                            <i class="fas fa-bell w-5 mr-3"></i>
                            Notifications
                        </a>
                        <a href="#preferences" class="flex items-center p-3 text-gray-700 hover:text-primary-400 hover:bg-gray-100/50 rounded-lg transition-colors">
                            <i class="fas fa-cog w-5 mr-3"></i>
                            Preferences
                        </a>
                        <a href="#privacy" class="flex items-center p-3 text-gray-700 hover:text-primary-400 hover:bg-gray-100/50 rounded-lg transition-colors">
            ...
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('user.settings.update') }}">
                    ...
                    <div id="notifications" class="bg-white rounded-xl border border-gray-200/30 p-6 mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">
                            <i class="fas fa-bell text-primary-400 mr-2"></i>
                            Notification Preferences
                        </h3>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between p-4 bg-gray-50/30 rounded-lg">
                                <div>
                                    <h4 class="text-gray-900 font-medium">Email Notifications</h4>
                                    <p class="text-gray-600 text-sm">Receive order updates and important notifications via email</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50/30 rounded-lg">
                                <div>
                                    <h4 class="text-gray-900 font-medium">SMS Notifications</h4>
                                    <p class="text-gray-600 text-sm">Receive order status updates via SMS</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50/30 rounded-lg">
                                <div>
                                    <h4 class="text-gray-900 font-medium">Marketing Notifications</h4>
                                    <p class="text-gray-600 text-sm">Receive promotional offers and new product updates</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <!-- Preference Settings -->
                    <div id="preferences" class="bg-white rounded-xl border border-gray-200/30 p-6 mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="language" name="language" class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:border-primary-500">
                    ...
                    <!-- Privacy Settings -->
                    <div id="privacy" class="bg-white rounded-xl border border-gray-200/30 p-6 mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">
                            <i class="fas fa-shield-alt text-primary-400 mr-2"></i>
                            Privacy & Security
                        </h3>
                        <div class="space-y-4">
                            <div class="p-4 bg-gray-50/30 rounded-lg">
                                <h4 class="text-gray-900 font-medium mb-2">Profile Visibility</h4>
                                <p class="text-gray-600 text-sm mb-3">Control who can see your profile information</p>
                                <select class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:border-primary-500">
                                    <option value="private">Private (Only you)</option>
                                    <option value="limited">Limited (CHANCE LAPTOPS Staff only)</option>
                                </select>
                            </div>

                            <div class="p-4 bg-gray-50/30 rounded-lg">
                                <h4 class="text-gray-900 font-medium mb-2">Order History Visibility</h4>
                                <p class="text-gray-600 text-sm mb-3">Choose who can view your order history</p>
                                <select class="w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:border-primary-500">
                                    <option value="private">Private (Only you and CHANCE LAPTOPS support)</option>
