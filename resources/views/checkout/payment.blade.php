...
@section('title', 'Checkout Payment - CHANCE LAPTOPS')
...
<div class="min-h-screen bg-gradient-to-br from-white via-red-50 to-slate-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-700">Complete your purchase with secure payment</p>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       class="h-4 w-4 text-green-500 focus:ring-green-500 border-gray-300 rounded bg-white"
                    ...
                    <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            <!-- Bank Transfer -->
                            <label class="flex items-center p-4 border border-gray-300 rounded-lg hover:border-green-400 transition-colors cursor-pointer">
                                <input type="radio" 
                                       name="payment_method" 
                                       value="bank_transfer"
                                       checked
                                       class="h-4 w-4 text-green-500 focus:ring-green-500 border-gray-300 bg-white">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-500 text-white">
                            Most Popular
                                    ...
                                    <div class="text-sm text-gray-600">Direct bank transfer • No transaction fees</div>
                                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6 sticky top-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center space-x-2">
                            <svg class="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div id="cart-items-summary" class="space-y-3 mb-6">
                            <div class="text-center py-4">
                                ...
                                <p class="text-gray-600 text-sm mt-2">Loading cart items...</p>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-300 pt-4 space-y-3">
                            ...
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="text-red-400 text-xs">Pay on delivery</span>
                            </div>
                        ...
                        <div class="border-t border-gray-300 pt-4 mt-4">
                            <label class="flex items-start">
                                <input type="checkbox" 
                                       ...
                                       required
                                       checked
                                       class="h-4 w-4 text-green-500 focus:ring-green-500 border-gray-300 rounded bg-white mt-0.5">
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{ route('checkout.index') }}" class="text-gray-600 hover:text-green-400 text-sm transition-colors">
                                ← Back to options
                            </a>
                        </div>
                    </div>
...
function displayCartItems(items) {
    ...
    if (items.length === 0) {
        container.innerHTML = '<p class="text-gray-600 text-sm">No items in cart</p>';
        return;
    }
