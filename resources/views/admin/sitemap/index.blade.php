...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Sitemap Management</h1>
            <p class="text-gray-600">Manage and regenerate sitemaps for Google Search Console</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <button id="refresh-btn"
                    class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-200 text-gray-900 text-sm font-medium rounded-lg transition-colors">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                </svg>
                Refresh Status
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
        ...
        <div class="bg-gradient-to-br from-red-500/10 to-red-600/5 border border-red-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-red-400 text-sm font-medium">Total Pages</p>
                    <p id="total-pages" class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['total_pages']) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="categories-count" class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['categories']) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="products-count" class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['products']) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 border border-yellow-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="files-count" class="text-2xl lg:text-3xl font-bold text-gray-900">{{ count($stats['sitemap_files']) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-indigo-500/10 to-indigo-600/5 border border-indigo-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p id="last-generated" class="text-lg lg:text-xl font-bold text-gray-900">
    ...
    <div class="bg-gradient-to-br from-primary-500/10 to-primary-600/5 border border-primary-500/20 rounded-xl p-4 lg:p-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Google Search Console Submission</h3>
                <p class="text-gray-700 text-sm mb-3">Submit this URL to Google Search Console for complete coverage:</p>
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <button onclick="navigator.clipboard.writeText('{{ url('/sitemap-index.xml') }}')" 
                            class="inline-flex items-center px-3 py-2 bg-gray-600/20 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-600/30 transition-colors">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gray-100 border border-gray-300 rounded-xl overflow-hidden">
        <div class="px-4 lg:px-6 py-4 border-b border-gray-300">
            <h3 class="text-lg font-semibold text-gray-900">Sitemap Files</h3>
        ...
        <div class="divide-y divide-gray-700">
            <ul id="sitemap-files" class="divide-y divide-gray-700">
                ...
                <li class="px-4 lg:px-6 py-4 hover:bg-gray-100/30 transition-colors">
                ...
                <li class="px-4 lg:px-6 py-12">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-700 mb-2">No sitemap files found</h3>
                        <p class="text-gray-600 mb-4">Click "Regenerate All Sitemaps" to create them.</p>
...
<!-- Loading Modal -->
<div id="loading-modal" class="hidden fixed inset-0 bg-gray-100/80 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-6 border border-gray-300 w-96 shadow-2xl rounded-xl bg-gray-50">
        <div class="text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Generating Sitemaps</h3>
            <div class="mb-4">
