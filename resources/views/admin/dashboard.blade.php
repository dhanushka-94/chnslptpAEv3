...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-primary-500/10 to-primary-600/5 border border-primary-500/20 rounded-xl p-6">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="text-center">
                    <div class="text-lg font-semibold text-gray-900">{{ $stats['today_pending'] }}</div>
                    <div class="text-xs text-yellow-400">Pending</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-gray-900">{{ $stats['today_orders'] - $stats['today_pending'] }}</div>
        ...
        <div class="bg-gradient-to-br from-gray-500/10 to-gray-600/5 border border-gray-500/20 rounded-xl p-6">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="text-center">
                    <div class="text-lg font-semibold text-gray-900">{{ $stats['yesterday_pending'] }}</div>
                    <div class="text-xs text-yellow-400">Pending</div>
                </div>
                <div class="text-center">
                    <div class="text-lg font-semibold text-gray-900">{{ $stats['yesterday_orders'] - $stats['yesterday_pending'] }}</div>
                    <div class="text-xs text-green-400">Processed</div>
                </div>
                <div class="text-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.orders.index', ['filter' => 'yesterday']) }}" 
                   class="flex-1 bg-gray-500/20 hover:bg-gray-500/30 text-gray-700 px-4 py-2 rounded-lg text-center text-sm font-medium transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <!-- Sales Chart -->
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Monthly Sales (Last 6 Months)</h3>
            <div class="h-64">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Today's Orders ({{ $todayOrders->count() }})</h3>
                    <a href="{{ route('admin.orders.index', ['filter' => 'today']) }}" 
            ...
            @if($todayOrders->count() > 0)
                <div class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                    @foreach($todayOrders->take(8) as $order)
                        <div class="px-6 py-4 hover:bg-gray-100/30 transition-colors">
            ...
            @else
                <div class="px-6 py-8 text-center">
                    ...
                    <p class="text-gray-600">No orders today yet</p>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Yesterday's Orders ({{ $yesterdayOrders->count() }})</h3>
                    <a href="{{ route('admin.orders.index', ['filter' => 'yesterday']) }}" 
                    ...
                    @foreach($yesterdayOrders->take(8) as $order)
                        <div class="px-6 py-4 hover:bg-gray-100/30 transition-colors">
                            <div class="flex items-center justify-between mb-2">
                                <div>
                                    <p class="text-sm font-medium text-white">
                                        <a href="{{ route('admin.orders.show', $order) }}" class="hover:text-gray-700">
                                            #{{ $order->order_number ?? $order->id }}
                                        </a>
                                    </p>
                                    <p class="text-sm text-gray-600">{{ $order->customer_name ?? $order->customer_email }}</p>
            ...
            @else
                <div class="px-6 py-8 text-center">
                    ...
                    <p class="text-gray-600">No orders yesterday</p>
                </div>
            @endif
        </div>
    </div>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.orders.index') }}" class="text-red-600 hover:text-[#d97706] text-sm font-medium transition-colors">
                        View All
                    </a>
                </div>
            </div>
    ...
    <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin.users.index') }}" class="text-red-600 hover:text-[#d97706] text-sm font-medium transition-colors">
                    View All
                </a>
            </div>
        </div>
