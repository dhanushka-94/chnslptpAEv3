...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Manually create a new order for a customer</p>
        </div>
        <a href="{{ route('admin.orders.index') }}" class="bg-gray-600 hover:bg-gray-200 text-gray-900 px-6 py-3 rounded-lg transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="customer_id" name="customer_id" required onchange="fillCustomerInfo()"
                            class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 focus:outline-none focus:border-primary-500 @error('customer_id') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="customer_name" name="customer_name" value="{{ old('customer_name') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('customer_name') border-red-500 @enderror">
                    @error('customer_name')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="customer_email" name="customer_email" value="{{ old('customer_email') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('customer_email') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="customer_phone" name="customer_phone" value="{{ old('customer_phone') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('customer_phone') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="billing_address_line_1" name="billing_address_line_1" value="{{ old('billing_address_line_1') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('billing_address_line_1') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="billing_city" name="billing_city" value="{{ old('billing_city') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('billing_city') border-red-500 @enderror">
                    @error('billing_city')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="billing_state" name="billing_state" value="{{ old('billing_state') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500 @error('billing_state') border-red-500 @enderror">
                    @error('billing_state')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="billing_postal_code" name="billing_postal_code" value="{{ old('billing_postal_code') }}" required
                           class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-5002 @error('billing_postal_code') border-red-500 @enderror">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="items[0][product_name]" required
                                           class="w-full bg-gray-600 border border-gray-500 rounded-lg px-4 py-2 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" readonly class="item-total w-full bg-gray-50 border border-gray-300 rounded-lg px-4 py-2 text-gray-600">
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="button" onclick="addOrderItem()" class="mt-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg transition-colors">
                ...
                <div>
                    ...
                    <select id="status" name="status" required
                            class="w-full bg-gray-700 border border-gray-300 rounded-lg px-4 py-2 text-gray-900 focus:outline-none focus:border-primary-500">
