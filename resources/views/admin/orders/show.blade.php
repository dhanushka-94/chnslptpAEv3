...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-gray-600">Order placed on {{ $order->created_at->format('F d, Y \a\t g:i A') }}</p>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">{{ $order->orderItems->count() }}</p>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select id="status" name="status" required
                                class="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <div id="shipping-fields" style="{{ $order->status === 'shipped' ? '' : 'display: none;' }}">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="courier_service" class="block text-sm font-medium text-gray-700 mb-2">Courier Service</label>
                                <input type="text" 
                                       id="courier_service" 
                    ...
                    <div>
                        ...
                        <textarea id="admin_notes" 
                                  ...
                                  class="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500">{{ old('admin_notes', $order->admin_notes) }}</textarea>
                    </div>

                    <button type="submit" 
                            class="w-full py-2 px-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium">
                        Update Status
                    </button>
                </div>
            </form>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            ...
            <form action="{{ route('admin.orders.update-payment', $order) }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="payment_reference" class="block text-sm font-medium text-gray-700 mb-2">Payment Reference</label>
                        <input type="text" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- Order Items -->
        <div class="lg:col-span-2 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <h4 class="text-gray-900 font-medium">{{ $item->product_name }}</h4>
                                    @if($hasDiscount)
                                ...
                                @if($item->product_code)
                                    <p class="text-sm text-gray-600">Code: {{ $item->product_code }}</p>
                                @endif
            ...
            <div class="px-6 py-4 border-t border-gray-200 bg-gray-50/20">
                <h4 class="text-lg font-medium text-gray-900 mb-4">💰 Order Summary Breakdown</h4>
                ...
                <div class="space-y-3">
                    ...
                    <div class="bg-gray-700/30 rounded-lg p-4">
                        <h5 class="text-sm font-medium text-gray-700 mb-2">🛍️ Product Pricing</h5>
                    ...
                    @if($order->shipping_cost > 0 || $order->tax_amount > 0 || $order->discount_amount > 0)
                        <div class="bg-gray-700/30 rounded-lg p-4">
                            <h5 class="text-sm font-medium text-gray-700 mb-2">📦 Additional Charges</h5>
                            <div class="space-y-2 text-sm">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                @if($order->payment_reference)
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-red-400 font-mono text-xs">{{ $order->payment_reference }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                @if($order->user)
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Registered Customer</p>
                        </div>
                    </div>
                @endif
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    ...
                    @elseif($order->payment_method === 'bank_transfer')
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between">
                                <span class="text-gray-600">🏦 Transfer Slip</span>
                                <div class="flex items-center space-x-2">
                                        ...
                                        @else
                                            ...
                                            <div class="w-32 h-32 bg-gray-100 rounded-lg border border-gray-300 flex items-center justify-center">
                                                <div class="text-center">
                                                    ...
                                                    <span class="text-xs text-gray-600 font-medium">{{ strtoupper($fileExtension) }}</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="space-y-2">
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-600">{{ basename($order->transfer_slip_path) }}</div>
                                            </div>
                    ...
                    @if($order->payment_reference)
                        <div>
                            <div class="text-gray-600 text-sm mb-1">Transaction ID</div>
                            <div class="bg-gray-50 p-2 rounded text-white font-mono text-sm break-all">
                ...
                <div class="space-y-3">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="text-sm">
                            ...
                            <span class="text-gray-600 block">{{ $order->created_at->format('M d, Y \a\t g:i A') }}</span>
                        </div>
                    </div>
                    @if($order->shipped_at)
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-sm">
                                <span class="text-gray-900 font-medium">Shipped</span>
                                <span class="text-gray-600 block">{{ $order->shipped_at->format('M d, Y \a\t g:i A') }}</span>
                            </div>
                        </div>
                    @endif
                    @if($order->delivered_at)
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-sm">
                                <span class="text-gray-900 font-medium">Delivered</span>
                                <span class="text-gray-600 block">{{ $order->delivered_at->format('M d, Y \a\t g:i A') }}</span>
                            </div>
                        </div>
                    @endif
                </div>
...
<!-- Image Modal -->
<div id="imageModal" class="fixed inset-0 bg-slate-50 bg-opacity-75 flex items-center justify-center z-50 hidden">
    <div class="max-w-4xl max-h-full p-4">
        <div class="bg-gray-100 rounded-lg overflow-hidden">
            <div class="flex items-center justify-between p-4 border-b border-gray-300">
                <h3 id="modalTitle" class="text-lg font-medium text-gray-900"></h3>
                <button onclick="closeImageModal()" class="text-gray-600 hover:text-red-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
