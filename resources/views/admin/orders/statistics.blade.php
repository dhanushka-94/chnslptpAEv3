...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600">Comprehensive analytics and insights for order management</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900">{{ number_format($stats['today_orders']) }}</p>
                    <p class="text-sm text-red-400">New orders today</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['processing_orders']) }}</p>
                    <a href="{{ route('admin.orders.index', ['status' => 'processing']) }}" 
                       class="text-sm text-red-400 hover:text-red-300 transition-colors">View orders →</a>
                </div>
                <div class="p-3 bg-red-500/20 rounded-lg">
        ...
        <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('admin.orders.create') }}" 
                   class="flex items-center justify-between p-2 bg-red-500/10 border border-red-500/20 rounded-lg hover:bg-red-500/20 transition-colors">
                    <span class="text-red-400 text-sm">➕ Create New Order</span>
    ...
    <!-- Recent Activity -->
    <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
        <h3 class="text-lg font-medium text-gray-900 mb-6">📊 Statistics Overview</h3>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-2xl font-bold text-red-400">{{ number_format($stats['today_orders']) }}</div>
