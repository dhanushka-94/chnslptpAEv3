...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Viewing {{ $user->name }}'s profile</p>
        </div>
                            ...
                            @foreach($user->addresses as $address)
                                <div class="bg-gray-700 rounded-lg p-4">
                                    ...
                                    @if($address->contact_phone)
                                        <p class="text-sm text-gray-600 mt-2">{{ $address->contact_phone }}</p>
                                    @endif
                                </div>
                            @endforeach
                        </div>
