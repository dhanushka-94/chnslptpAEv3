...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600">Monitor system and user activities</p>
        </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <!-- Total Activities -->
        <div class="bg-gradient-to-br from-red-500/10 to-red-600/5 border border-red-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-red-400 text-sm font-medium">Total Activities</p>
                    <p class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['total_activities'] ?? 0) }}</p>
                </div>
                <div class="bg-red-500/20 p-2 lg:p-3 rounded-lg">
        ...
        <div class="bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['by_type']['customer'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['by_type']['system'] ?? 0) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20 rounded-xl p-4 lg:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl lg:text-3xl font-bold text-gray-900">{{ number_format($stats['by_type']['admin'] ?? 0) }}</p>
                </div>
    ...
    <!-- Filters and Search -->
    <div class="bg-gray-100 border border-gray-300 rounded-xl p-4 lg:p-6">
            ...
            <div class="flex-1">
                ...
                <div class="relative">
                    <input type="text" id="search" name="search" 
                           ...
                           class="w-full bg-gray-100/50 border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg px-4 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select id="type" name="type" 
                            class="w-full bg-gray-100/50 border border-slate-300 text-slate-900 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                ...
                <div class="flex items-end">
                    <button type="button" id="apply-filters"
                            class="w-full bg-primary-600 hover:bg-primary-700 text-gray-900 font-medium py-2 px-4 rounded-lg transition-colors">
                        Apply Filters
                    </button>
                </div>
            </div>
    ...
    <div class="bg-gray-100 border border-gray-300 rounded-xl overflow-hidden">
        <div class="px-4 lg:px-6 py-4 border-b border-gray-300">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-700">
                <thead class="bg-gray-100/50">
                    <tr>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Activity</th>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider hidden sm:table-cell">User</th>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider hidden md:table-cell">Type</th>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider hidden lg:table-cell">IP Address</th>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Time</th>
                        <th class="px-4 lg:px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Actions</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-700">
                    @forelse($activities as $log)
                    <tr class="hover:bg-gray-100/30 transition-colors">
                        ...
                        <td class="px-4 lg:px-6 py-4">
                            <div class="flex flex-col">
                                ...
                                <div class="text-xs text-gray-600 mt-1 sm:hidden">
                    ...
                    <tr>
                        <td colspan="6" class="px-4 lg:px-6 py-12 text-center">
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-700 mb-2">No activity logs found</h3>
                                <p class="text-gray-600">Activities will appear here as users interact with the system.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
        ...
        <div class="px-4 lg:px-6 py-4 border-t border-gray-300">
