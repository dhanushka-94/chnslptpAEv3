...
<div class="space-y-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
                <div class="flex items-start justify-between mb-6">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-900 mb-2">Activity Description</h2>
                        <p class="text-gray-700 text-lg leading-relaxed">{{ $activityLog->description }}</p>
                    </div>
                    <div class="ml-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <!-- Action -->
                    <div>
                        <h3 class="text-sm font-medium text-gray-600 mb-2">Action</h3>
                    ...
                    <!-- Severity -->
                    <div>
                        <h3 class="text-sm font-medium text-gray-600 mb-2">Severity</h3>
                        <div class="flex items-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-sm font-medium
                                {{ $activityLog->severity == 'critical' ? 'bg-red-500/20 text-red-400 border border-red-500/20' :
                                   ...
                                   ($activityLog->severity == 'medium' ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/20' : 'bg-red-500/20 text-red-400 border border-red-500/20')) }}">
                        ...
                        <div class="flex items-center">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-sm font-medium
                                {{ $activityLog->status == 'success' ? 'bg-green-500/20 text-green-400 border border-green-500/20' :
                                   ($activityLog->status == 'failed' ? 'bg-red-500/20 text-red-400 border border-red-500/20' : 'bg-gray-500/20 text-gray-600 border border-gray-500/20') }}">
                    ...
                    <!-- Log Name -->
                    <div>
                        <h3 class="text-sm font-medium text-gray-600 mb-2">Log Category</h3>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $activityLog->created_at->format('F j, Y') }}</p>
                        <p class="text-gray-700 text-sm">{{ $activityLog->created_at->format('g:i:s A') }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Time Ago</p>
            ...
            <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $activityLog->causer->name }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-900 font-medium">Automated Action</p>
                        <p class="text-gray-600 text-sm">No user associated</p>
                    </div>
                </div>
            </div>
            @endif
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <p class="text-sm text-gray-600 mb-1">HTTP Method</p>
                    <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium
                        {{ $activityLog->method == 'GET' ? 'bg-red-500/20 text-red-400' :
                           ($activityLog->method == 'POST' ? 'bg-green-500/20 text-green-400' :
                           ($activityLog->method == 'PUT' ? 'bg-yellow-500/20 text-yellow-400' :
                           ($activityLog->method == 'DELETE' ? 'bg-red-500/20 text-red-400' : 'bg-gray-500/20 text-gray-600'))) }}">
        ...
        <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
            ...
            <div class="space-y-4">
                <div>
                    <p class="text-sm text-gray-600 mb-1">Device</p>
                ...
                <div>
                    <p class="text-sm text-gray-600 mb-1">Browser</p>
                    <p class="text-white">{{ $activityLog->browser ?: 'Unknown' }}</p>
                </div>
                @if($activityLog->user_agent)
                <div>
                    <p class="text-sm text-gray-600 mb-1">User Agent</p>
                    <p class="text-gray-700 text-xs font-mono break-all bg-gray-100/50 p-2 rounded">{{ $activityLog->user_agent }}</p>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="bg-gray-100 border border-gray-300 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Additional Properties</h3>
        <div class="bg-gray-100/50 rounded-lg p-4 overflow-x-auto">
            <pre class="text-sm text-gray-700"><code>{{ json_encode($activityLog->properties, JSON_PRETTY_PRINT) }}</code></pre>
        </div>
    </div>
    @endif
