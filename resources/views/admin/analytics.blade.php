...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Sales performance and business insights</p>
        </div>
        <a href="{{ route('admin.dashboard') }}" class="bg-gray-600 hover:bg-gray-200 text-gray-900 px-6 py-3 rounded-lg transition-colors">
        ...
        <form method="GET" action="{{ route('admin.analytics') }}">
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <!-- Quick Presets -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Quick Periods</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Legacy Periods</label>
                        <select name="period" class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-red-500">
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        @if(request()->hasAny(['date_from', 'date_to', 'period']))
                            <a href="{{ route('admin.analytics') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors text-sm flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if(request()->hasAny(['date_from', 'date_to', 'period']))
                    <div class="flex flex-wrap gap-2 pt-2 border-t border-gray-300">
                        <span class="text-sm text-gray-600 mr-2">Active Period:</span>
                        
                        @if(request('date_from') || request('date_to'))
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-red-900/50 text-red-200 border border-red-700">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @endif
                                <a href="{{ route('admin.analytics', request()->except(['date_from', 'date_to'])) }}" class="ml-2 text-red-300 hover:text-red-100">×</a>
                            </span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-red-100 text-sm">Total Orders</p>
                    <p class="text-2xl font-bold">{{ number_format($revenueData->sum('orders')) }}</p>
                    <p class="text-red-100 text-sm mt-1">Last {{ $period }} days</p>
                </div>
    ...
    <div class="bg-gray-50 rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="text-sm text-gray-600">Last {{ $period }} days</div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <span class="text-sm text-gray-600">Last {{ $period }} days</span>
            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">{{ $product->total_sold }} units sold</p>
                                </div>
                            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-700 rounded-lg p-4">
                    <h4 class="text-gray-900 font-medium mb-3">Customer Types</h4>
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-700">Repeat Customers</span>
                ...
                <div class="bg-gray-700 rounded-lg p-4">
                    <h4 class="text-gray-900 font-medium mb-3">Growth Metrics</h4>
                    <div class="space-y-3">
                        @php
                        ...
                        @endphp
                        <div class="flex justify-between items-center">
                            <span class="text-gray-700">New Customer Rate</span>
                            <span class="text-green-400 font-semibold">{{ number_format($newCustomerRate, 1) }}%</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-700">Repeat Purchase Rate</span>
                            <span class="text-red-400 font-semibold">{{ number_format($repeatRate, 1) }}%</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Quick Actions -->
                <div class="pt-4">
                    <h4 class="text-gray-900 font-medium mb-3">Quick Actions</h4>
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('admin.users.index') }}" 
                           class="block w-full text-center bg-gray-600 hover:bg-gray-200 text-gray-900 py-2 px-4 rounded-lg transition-colors">
    ...
    <!-- Additional Insights -->
    <div class="bg-gray-50 rounded-lg p-6">
        <h3 class="text-xl font-semibold text-gray-900 mb-6">Business Summary</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center">
                ...
                <div class="text-gray-600 mt-1">Average Daily Orders</div>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold text-red-400">
                    {{ $productPerformance->count() }}
                </div>
                <div class="text-gray-600 mt-1">Products Sold</div>
            </div>
        </div>
    </div>
</div>
