...
@section('title', 'Complete Card Payment - CHANCE LAPTOPS')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-white via-red-50 to-slate-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Header -->
        <div class="text-center mb-8">
            <div class="flex items-center justify-center space-x-4 mb-6">
                <img src="{{ asset('chance-laptops-logo.png') }}" alt="Chance Laptops" class="w-24 h-24">
                <div class="text-4xl text-gray-600">→</div>
                <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/webxpay-logo.webp') }}" alt="WebXPay" class="h-10">
                </div>
            </div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Complete Card Payment</h1>
            <p class="text-gray-600">Secure payment processing via WebXPay</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex justify-between items-center p-3 bg-white rounded-lg">
                        <div>
                            ...
                            <p class="text-gray-600 text-xs">{{ $item->quantity }} × LKR {{ number_format($item->unit_price, 2) }}</p>
                        </div>
                ...
                <div class="border-t border-gray-300 pt-4 space-y-3">
                    ...
                    <div class="flex justify-between text-sm">
                        <span class="text-red-400">Transaction Fee (3%):</span>
                        <span class="text-red-400">+LKR {{ number_format($transactionFee, 2) }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="first_name" value="{{ $paymentData['first_name'] }}" 
                                   class="w-full bg-white border border-gray-300 text-white px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" 
                                   required>
                        </div>
                        <div>
