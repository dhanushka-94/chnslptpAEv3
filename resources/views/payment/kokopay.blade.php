...
@section('title', 'Complete Your Secure Payment - CHANCE LAPTOPS')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-white via-red-50 to-slate-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- Simple Header -->
        <div class="text-center mb-8">
            <div class="flex items-center justify-center space-x-3 mb-4">
                <div class="bg-gradient-to-r from-purple-600 to-red-600 p-3 rounded-xl shadow-lg">
                    <img src="{{ asset('images/kokopay-logo.png') }}" alt="Koko Pay" class="h-8 brightness-0 invert">
                </div>
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Complete Your Secure Payment</h1>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-300 last:border-b-0">
                        <div class="flex-1">
                            <p class="text-gray-900 font-medium text-sm">{{ $item->product_name }}</p>
                ...
                <div class="border-t border-gray-300 pt-4">
                    ...
                    <p class="text-xs text-gray-600 mt-1">Includes 10% processing fee</p>
                </div>

                <!-- Payment Plan -->
                <div class="mt-6 bg-gradient-to-r from-purple-900/20 to-red-900/20 rounded-lg p-4 border border-purple-700/30">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-700">In 30 days:</span>
                            <span class="text-gray-700">LKR {{ number_format($totalWithFee / 3, 2) }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-700">In 60 days:</span>
                            <span class="text-gray-700">LKR {{ number_format($totalWithFee / 3, 2) }}</span>
                        </div>
                    </div>
                ...
                <form action="{{ $apiUrl }}" method="POST" id="kokopay-form" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="w-full bg-white border border-gray-300 text-white px-4 py-3 rounded-lg">
                    ...
                    <div class="bg-red-900/20 border border-red-700/50 rounded-lg p-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h4 class="text-red-400 font-medium text-sm">Important Information</h4>
                    ...
                    <div class="space-y-4 pt-6">
                        ...
                        <button type="submit" 
                                class="w-full relative overflow-hidden bg-gradient-to-r from-purple-600 via-purple-700 to-red-600 text-white font-bold py-5 px-8 rounded-2xl hover:from-purple-700 hover:via-purple-800 hover:to-red-700 transition-all duration-500 flex items-center justify-center shadow-2xl shadow-purple-500/25 ring-2 ring-purple-500/20 hover:ring-purple-400/40 hover:shadow-purple-500/40 transform hover:scale-105 hover:-translate-y-1 group">
                            <!-- Animated background gradient -->
                            <div class="absolute inset-0 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
                            ...
                            <div class="relative flex items-center justify-center">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-sm font-semibold text-purple-100 group-hover:text-red-600 transition-colors duration-300">
                        ...
                        <a href="{{ route('checkout.index') }}" 
                           class="w-full relative overflow-hidden bg-gradient-to-r from-white via-slate-50 to-white text-white font-semibold py-4 px-6 rounded-xl hover:from-red-50 hover:via-white hover:to-red-50 transition-all duration-300 flex items-center justify-center shadow-xl shadow-red-500/10 ring-1 ring-red-200 hover:ring-red-300 transform hover:scale-102 hover:-translate-y-0.5 group border border-gray-300/50">
                            <!-- Button content -->
