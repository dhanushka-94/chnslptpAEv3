...
@section('title', 'Categories - CHANCE LAPTOPS')
@section('description', 'Browse our computer hardware categories including gaming PCs, laptops, monitors, and components at CHANCE LAPTOPS.')
...
<section class="bg-white py-6 md:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Product Categories</h1>
            <p class="text-base md:text-lg text-gray-700">Explore our comprehensive range of computer hardware and technology solutions</p>
        </div>
    </div>
</section>
                        ...
                        <div class="card card-hover overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary-500/20">
                            ...
                            <div class="relative p-6 bg-gradient-to-br from-gray-50 to-white">
                                <div class="flex flex-col items-center">
                                    ...
                                    <!-- Category Name -->
                                    <h3 class="text-center text-gray-900 font-semibold text-sm md:text-base mb-1 group-hover:text-primary-600 transition-colors line-clamp-2">
                                        {{ $category->name }}
                                    </h3>
...
<section class="py-12 bg-gray-100/50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Need Help Finding Something?</h2>
        <p class="text-gray-700 mb-6">Our expert team can help you find the perfect computer solution</p>
