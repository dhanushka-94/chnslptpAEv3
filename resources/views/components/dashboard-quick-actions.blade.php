...
<div class="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
           ...
           class="flex items-center justify-between p-3 bg-primary-500/10 border border-primary-500/20 rounded-lg hover:bg-primary-500/20 transition-colors group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600">{{ $stats['today_orders'] }} orders</p>
                </div>
            </div>
           ...
           class="flex items-center justify-between p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg hover:bg-yellow-500/20 transition-colors group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600">{{ $stats['pending_orders'] }} orders</p>
                </div>
            </div>
        ...
        <a href="{{ route('admin.orders.index', ['filter' => 'this_week']) }}" 
           class="flex items-center justify-between p-3 bg-red-500/10 border border-red-500/20 rounded-lg hover:bg-red-500/20 transition-colors group">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600">{{ $stats['weekly_orders'] }} orders</p>
                </div>
            </div>
