...
@section('title', 'Warranty Certificate and Terms - Chance Laptops (Pvt) Ltd')
@section('description', 'Warranty coverage and terms from Chance Laptops (Pvt) Ltd. වගකීම් සහතිකය හා අදාළ කොන්දේසි')

@section('content')
<!-- Page Header -->
<section class="bg-gradient-to-br from-white via-red-50 to-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
                ...
                <br>
                <span class="text-2xl md:text-3xl text-gray-700">වගකීම් සහතිකය</span>
            </h1>
            <p class="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Warranty terms issued by Chance Laptops (Pvt) Ltd — clear coverage for manufacturing defects, with your bill required for claims.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-gray-200 rounded-xl p-8 mb-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Bill Required</h3>
                            <p class="text-sm text-gray-600">බිල්පත අනිවාර්යයි</p>
                        </div>
                    </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Manufacturing Defects Only</h3>
                            <p class="text-sm text-gray-600">නිෂ්පාදිත දෝෂ පමණක්</p>
                        </div>
                    </div>
                    <p class="text-gray-700 text-sm leading-relaxed mb-4">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-8 mb-8">
                    <div class="flex items-center mb-6">
                        <div class="w-12 h-12 bg-[#E30613] rounded-xl flex items-center justify-center mr-4">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22C6.47,22 2,17.5 2,12A10,10 0 0,1 12,2M12.5,7V12.25L17,14.92L16.25,16.15L11,13V7H12.5Z"/>
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Processing Time</h3>
                            <p class="text-sm text-gray-600">ක්‍රියාත්මක කිරීමේ කාලය</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-lg p-6 text-center">
                            <div class="text-3xl font-bold text-red-600 mb-2">1 Year</div>
                            <div class="text-sm text-gray-600">350 days</div>
                        </div>
                        <div class="bg-gradient-to-br from-[#10b981]/10 to-[#059669]/10 border border-[#10b981]/20 rounded-lg p-6 text-center">
                            ...
                            <div class="text-sm text-gray-600">700 days</div>
                        </div>
                        <div class="bg-gradient-to-br from-[#8b5cf6]/10 to-[#7c3aed]/10 border border-[#8b5cf6]/20 rounded-lg p-6 text-center">
                            ...
                            <div class="text-sm text-gray-600">1050 days</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">Warranty Exclusions</h3>
                            <p class="text-sm text-gray-600">වගකීම් බහිර්ගතයන්</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">පිළිස්සුණු ලකුණු</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">පෑස්සූ ලකුණු</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">මලකඩ කෑම</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">සීරීම් ලකුණු</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">අකුණු වලින් සිදුවී ඇති හානි</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">ආහාර හෝ බීම වර්ග හැලීමෙන් සිදුවන හානි</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">පරිගණක දැනුමක් නැති අය සිදුකරන වැරදි</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">ස්වාභාවික විපත් වැනි හානි</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Contact Section -->
        <div class="mt-12 bg-white border border-gray-200 rounded-xl p-8 text-center">
            <h3 class="text-2xl font-bold text-gray-900 mb-4">Need Help with Your Warranty?</h3>
            <p class="text-gray-600 mb-6">Contact Chance Laptops (Pvt) Ltd support for warranty assistance and claims</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('contact-us.index') }}" class="bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
                    Contact Support
                </a>
                <a href="tel:0112959005" class="bg-white border border-gray-300 hover:border-red-300 text-gray-900 px-8 py-3 rounded-lg font-semibold transition-colors">
                    Call: 0112 95 9005
                </a>
            </div>
        </div>
